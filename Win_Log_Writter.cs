...
namespace LAVS
{
	...
	public class Win_Log_Writter
	{
        ...
        string debugSource = "Accenture EDC Anti-Virus LAVS";
        int eid = 5;
		...
		public void write_to_log_Error(string Message)
		{
			string full_Message =    
										...
										+  "* Accenture EDC Anti-virus Erorr  " + System.Environment.NewLine
		...
		public void write_to_log_info(string Message)
		{
			string full_Message =    
										   "***********************************************************" + System.Environment.NewLine
										+  "* Accenture EDC Anti-virus Information  " + System.Environment.NewLine			
		...
		public void write_to_log_AVdebug(string debug_string)
		{
			string full_debug_string =    
										   "***********************************************************" + System.Environment.NewLine
										+  "* Accenture EDC Anti-virus Debuging Information  " + System.Environment.NewLine
                                        +  "* Immediate action is Required          " + System.Environment.NewLine								
					  					+  "***********************************************************"
				 						+ System.Environment.NewLine
